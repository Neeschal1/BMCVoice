...
//   handleSubmit,
  ...
  return (
    ...
    //               <div
    //                 key={image.id}
    //                 className="h-20 w-full overflow-hidden rounded-lg border border-slate-300 bg-slate-50"
    //               >
    //                 <img
    //                   src={image.url}
    //                   alt={image.name}
    ...
    //       {/* Error */}
    //       {error && (
    //         <div className="mb-4 flex items-center gap-2 rounded-lg border border-red-400 bg-red-50 px-4 py-2 text-sm text-red-700">
    //           <AlertCircle size={20} />
    //           {error}
    //         </div>
    //       )}
    ...
    <div>
        ...
        <h1 className="font-black ">{details}</h1>
    </div>
  );
};
